...
<execution_context>
@/Users/dev/.claude/gsd-core/workflows/execute-plan.md
@/Users/dev/.claude/gsd-core/templates/summary.md
</execution_context>

<context>
@/Users/dev/Projects/holzcloud-cms/CLAUDE.md
@/Users/dev/Projects/holzcloud-cms/internal/term/store.go
@/Users/dev/Projects/holzcloud-cms/internal/bundle/format.go
@/Users/dev/Projects/holzcloud-cms/tools/mkbundle/main.go
@/Users/dev/Projects/holzcloud-cms/tools/mkbundle/pack_test.go
@/Users/dev/Projects/holzcloud-cms/plugins/kontaktformular/eigenes.go
</context>
...
<task type="tracer" tdd="true">
  ...
  <verify>
    <automated>go -C /Users/dev/Projects/holzcloud-cms test ./tools/mkbundle/ ./internal/bundle/ && go -C /Users/dev/Projects/holzcloud-cms vet ./tools/mkbundle/ ./internal/bundle/ && grep -v '^\s*//' /Users/dev/Projects/holzcloud-cms/tools/mkbundle/main.go | grep -c 'terms\[t.Name\]' && test 0 -eq "$(grep -v '^\s*//' /Users/dev/Projects/holzcloud-cms/tools/mkbundle/main.go | grep -c 'terms\[t.Slug\]')" && test -z "$(git -C /Users/dev/Projects/holzcloud-cms diff --name-only -- internal/bundle/export.go internal/bundle/import.go)"</automated>
  </verify>
  <done>
...
<task type="auto">
  ...
  <verify>
    <automated>go -C /Users/dev/Projects/holzcloud-cms run ./tools/mkbundle sites/beispiel && go -C /Users/dev/Projects/holzcloud-cms test -v ./tools/mkbundle/ && go -C /Users/dev/Projects/holzcloud-cms vet ./tools/mkbundle/ && test -z "$(git -C /Users/dev/Projects/holzcloud-cms status --porcelain sites/beispiel.zip)"</automated>
  </verify>
  <done>
...
<task type="auto">
  ...
  <verify>
    <automated>go -C /Users/dev/Projects/holzcloud-cms test -count=400 -run TestMarkeMitUnbekanntemArgumentBleibtDerBetreff ./internal/public/ && test 0 -eq "$(grep -c 'seite, "f_"' /Users/dev/Projects/holzcloud-cms/internal/public/formular_e2e_test.go)" && go -C /Users/dev/Projects/holzcloud-cms test -v -count=1 -run TestMarkeMitUnbekanntemArgumentBleibtDerBetreff ./internal/public/ | grep -q -- '--- PASS'</automated>
  </verify>
  <done>
...
<verification>
Run from the repository root (or with `go -C /Users/dev/Projects/holzcloud-cms` as
...
go -C /Users/dev/Projects/holzcloud-cms build ./...
go -C /Users/dev/Projects/holzcloud-cms vet ./...
go -C /Users/dev/Projects/holzcloud-cms test ./... 2>&1 | tail -60   # 0 FAIL
...
go -C /Users/dev/Projects/holzcloud-cms test -count=400 \
  -run TestMarkeMitUnbekanntemArgumentBleibtDerBetreff ./internal/public/

# 3 — the run is real, not a skip
go -C /Users/dev/Projects/holzcloud-cms test -v -count=1 \
...
go -C /Users/dev/Projects/holzcloud-cms test -v ./tools/mkbundle/

# 5 — the example, which is now the shipped regression guard
go -C /Users/dev/Projects/holzcloud-cms run ./tools/mkbundle sites/beispiel
git -C /Users/dev/Projects/holzcloud-cms status --porcelain sites/   # only the manifest

# 6 — the reading side is untouched, and no dependency moved
git -C /Users/dev/Projects/holzcloud-cms diff --name-only -- \
...
go -C /Users/dev/Projects/holzcloud-cms run ./tools/i18n
```
</verification>
