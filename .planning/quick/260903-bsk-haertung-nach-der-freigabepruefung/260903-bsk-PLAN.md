...
@/Users/dev/Projects/holzcloud-cms/go.mod
@/Users/dev/Projects/holzcloud-cms/.github/workflows/security.yml
@/Users/dev/Projects/holzcloud-cms/internal/web/layoutdata.go
@/Users/dev/Projects/holzcloud-cms/cmd/holzcloud/templates/admin/base.html
</context>
...
<task type="tracer" tdd="true">
  ...
  <verify>
    <automated>cd /Users/dev/Projects/holzcloud-cms && go test ./internal/web/ -run 'TestSidebarFooterShowsBuildAndLicence|TestAdminRendersInTheRequestsLanguage|TestUnknownLanguageFallsBackToGerman|TestParseAdminTemplatesSucceeds' -count=1 -v 2>&1 | tail -30 && go vet ./internal/web/ && go run ./tools/i18n | python3 -c "
import re, sys
t = sys.stdin.read()
print(t)
...
<task type="auto">
  ...
  <verify>
    <automated>cd /Users/dev/Projects/holzcloud-cms && grep -Eq '^go 1\.26\.6$' go.mod && go version && before=$(shasum go.mod go.sum) && go mod tidy && test "$before" = "$(shasum go.mod go.sum)" && go build ./... && go vet ./... && go test ./... 2>&1 | tail -5 && python3 -c "
import yaml
...
<verification>
Run from `/Users/dev/Projects/holzcloud-cms` after all three tasks:
