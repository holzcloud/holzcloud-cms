...
**Plans**: 3/7 plans executed, in 5 waves. `06-01` is a strict predecessor of all six others, so D-01's "before any code is touched" is carried by the wave graph, not only by prose. Wave 2 runs `06-02` ∥ `06-03` ∥ `06-04`.
**Wave 1**
...
| 6. Aufräumen | v1.6 | 3/7 | In Progress|  |
