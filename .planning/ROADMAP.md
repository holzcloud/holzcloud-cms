...
### ✅ v2.1 — The Public Side Speaks the Visitor's Language (opened and closed 2026-09-13)
...
answered rather than deleted in `milestones/v2.1-phases/13-public-translation/13-CONTEXT.md` §2.
...
**Closed 2026-09-13.** 14 of 14 requirements satisfied; the audit is
`.planning/milestones/v2.1-MILESTONE-AUDIT.md`, the phase records are
`13-VERIFICATION.md` and `14-VERIFICATION.md`. Phase 14 ran a fifth plan the
roadmap did not foresee: the browser pass found that the consent sentence was
stored once per website, so a French visitor was asked in German. Three bugs
that were nobody's feature were found the same way, the largest being that no
answer to a form submission had ever reached a visitor on a **start page** —
the redirect was built from the slug `home`, and `/home` redirects to `/`
without its query.

---

### ✅ v2.2 — What the Server Promises, It Keeps (opened and closed 2026-09-14)
...
**Closed 2026-09-14.** 11 of 11 requirements satisfied; the audit is
`.planning/milestones/v2.2-MILESTONE-AUDIT.md`, the phase record is
`15-VERIFICATION.md`. Two defects were found that no ledger entry named, both by
chasing the entry that looked most trivial — a password-protected page offered
to shared caches, and cookie-dependent shop prices cached publicly. Twice the
conservative-looking fix was the wrong one and had to be narrowed; the second
time an existing test forced it.

---

### ✅ v2.3 — Every Word on a Page Belongs to Whoever Reads It (closed 2026-09-15)
...
### ✅ v2.4 — What Has Accumulated (2026-09-15 → 2026-09-17)
...
**Shape:** phase 17 took the work that is measurable and finished (DOC, SURF,
the two gaps); the administration under test was phase 18.

**Closed 2026-09-17. Thirteen requirements, thirteen met, none deferred.**
`internal/admin` 35.9 % → **59.3 %**, `internal/branding` 0 % → **95.7 %**, 164
mutations run and 158 caught. Eleven defects found — four of which would have
hurt an operator, five of which were sentences the translation gate did not know
existed — and every one of them found by writing a test for a screen rather than
by reading the code, which is the argument TEST-01 was written to make. Three
faults in the test harness itself came out with them. Full account in
...
pass — which, for the first time in this project, found nothing.
...
visitor was asked in German. That became 14-05 rather than a carried-over note.
...
| 17. What Has Accumulated | v2.4 | 3/4 | In progress | - |
