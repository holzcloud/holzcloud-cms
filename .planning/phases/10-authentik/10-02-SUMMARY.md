  ...
  - id: D3
    ...
    verification:
      ...
      - kind: integration
        ...
        status: pass
      - kind: e2e
        ref: "curl -H 'X-authentik-email: …' http://192.168.10.63:8123/admin/ and http://[2001:db8::7]:8123/admin/ against the built binary — 303 to /admin/login, both families, with and without the correct proxy secret"
        status: pass
    human_judgment: false
  - id: D4
...
1. IPv4 untrusted, identity headers:
   303 http://192.168.10.63:8123/admin/login
2. IPv6 untrusted, identity headers:
   303 http://[2001:db8::7]:8123/admin/login
