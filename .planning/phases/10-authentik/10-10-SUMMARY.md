...
coverage:
  ...
  - id: D6
    ...
    verification:
      - kind: other
        ref: "task 1 step 10: 303 -> /admin/login from 192.168.10.63 and from [2001:db8::7], five header shapes each incl. the underscore spelling and the real secret; positive control: the identical headers from 127.0.0.1 with the secret -> 200"
        status: pass
    human_judgment: false
  - id: D7
...
```
IPv4   192.168.10.63                                    (en0, non-loopback)
IPv6   2001:db8::7           (en0, global, autoconf secured)
...
```
                                             from 192.168.10.63          from [2001:db8::7]
...
from 192.168.10.63                               303 …/admin/login
from [2001:db8::7]    303 …/admin/login
...
```
SSO-03  X_authentik_username: redakteurin  from 192.168.10.63   ->  303 …/admin/login
